...
public class SharePicture extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnSharePicture.setOnClickListener(SharePicture.this);
            ...
            case R.id.btnSharePicture:
                if(receivedImageBitmap!=null){
                    if(edtDescription.getText().toString().equals("")){
                        FancyToast.makeText(getContext(),"You must give a description for Image",FancyToast.LENGTH_LONG,FancyToast.ERROR,true).show();
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                if(e==null){
                                    FancyToast.makeText(getContext(),"Image Shared successfully",FancyToast.LENGTH_LONG,FancyToast.SUCCESS,true).show();
                                }else {
                    ...
                    FancyToast.makeText(getContext(),"You must select an image",FancyToast.LENGTH_LONG,FancyToast.ERROR,true).show();
                }
                break;
        }
...
//            FancyToast.makeText(getContext(),"Permission Granted",FancyToast.LENGTH_LONG,FancyToast.SUCCESS,true).show();
